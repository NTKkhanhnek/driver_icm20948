...
#define GYRO_CAL_DURATION_MS       10000U
#define GYRO_CAL_SAMPLE_DELAY_MS   1U
#define GYRO_CAL_MAX_SAMPLES       10000U
...
int main(void)
{
    ...
    {
        gyro_calibration_ok = (ICM20948_CalibrateGyroTimed(GYRO_CAL_DURATION_MS,
                                                            GYRO_CAL_SAMPLE_DELAY_MS,
                                                            GYRO_CAL_MAX_SAMPLES) == ICM20948_OK);
